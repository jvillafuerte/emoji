...
const App: FC = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col landscape:flex-row-reverse landscape:px-10 bg-gradient-to-b from-[#1A3A81] from-10% via-[#7BAAF1] via-50% to-[#AFD2C1] to-90%'>
